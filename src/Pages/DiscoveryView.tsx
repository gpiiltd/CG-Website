      ...
      <div className="bg-[#0F082B] text-white px-[7%]">
        <div className="rounded-xl pt-[7%] pb-[7%] flex flex-col md:flex-row  justify-center">
          ...
          <div className="flex-1 text-center md:text-left mt-0 md:mt-0 md:pr-14">
            ...
            <Typography weight="light" className="mt-2 mb-4 text-gray-300">
              ...
              target, it is a strategic vehicle for equitable wealth redistribution and a foundation
              for sustainable development. By investing in indigenous talent, we cultivate critical
              independent thinkers, technical leaders, and empowered communities, transforming
              infrastructure excellence into a force of shared prosperity.
            </Typography>
          </div>
        </div>
        ...
        <div className="rounded-xl pb-[7%] flex md:flex-row-reverse flex-col items-center">
          ...
          <div className="flex-1 md:text-left">
            ...
            <Typography weight="light" className="mt-2 mb-4 text-gray-300">
              • <span className="font-bold">Donated over 4,000 textbooks</span> to secondary schools
              in support of science education that benefited 6,700+ students.
            </Typography>
            <Typography weight="light" className="mt-2 mb-4 text-gray-300">
        ...
        <div className="rounded-xl flex flex-col md:flex-row  justify-center">
          ...
          <div className="flex-1 text-center md:text-left mt-0 md:mt-0 md:pr-14">
            <Typography weight="normal" className="font-bold mb-8 text-[#3E3E41]">
              ...
              growth and global economies, Century Group stands at the nexus of proven expertise and

...
<Animate animationType='fadeIn' duration={2000}>
            <div className="bg-[#FFF7F4] px-[5%] md:py-[7%] py-[12%]">
              ...
              <Typography className="text-[#3E3E41] font-light md:text-[18px] w-[90%] md:w-[45%] mb-10">
                At Century Group, values define who we are and how we operate. These principles
                shape every decision we make and every partnership we build.
              </Typography>
              <CardGrid />
            </div>
          </Animate>
          ...
          <div className="md:py-[7%] py-[12%] text-center">
            ...
            <Typography
              weight="light"
              className="text-[#11092F] text-center md:w-[40%] m-auto mb-6"
            >
          ...
          <div className="bg-[#0F082B] text-white px-[7%]">
            <div className="rounded-xl pt-[7%] pb-[7%] flex flex-col md:flex-row  justify-center">
              ...
              <div className="flex-1 text-center md:text-left mt-0 md:mt-0 md:pr-14">
                ...
                <Typography weight="light" className="mt-2 mb-4 text-gray-300">
                  ...
                  people. our commitment to employ 15,000 Africans across our projects is not merely
                  a target, it is a strategic vehicle for equitable wealth redistribution and a
            ...
            <div className="rounded-xl pb-[7%] flex md:flex-row-reverse md:gap-10 flex-col items-center">
              ...
              <div className="flex-1 md:text-left">
                ...
                <Typography weight="light" className="mt-2 mb-4 text-gray-300">
                  • <span className="font-bold">Donated and equipped a library</span> for the
                  Nigerian University of Technology Management in Lagos.
                </Typography>
                <Typography weight="light" className="mt-2 mb-4 text-gray-300">
                ...
                <Typography weight="light" className="mt-2 mb-4 text-gray-300">
                  ...
                  collaboration with leading health institutions in 4 states (Rivers, Anambra,
                  Lagos, and Abuja).
                </Typography>
              </div>
            </div>

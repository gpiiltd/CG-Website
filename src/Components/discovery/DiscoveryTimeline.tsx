...
const years = [
  {
    year: 2003,
    milestones: [
      'Supported Dresser Rand in the operation and maintenance of the Eku flowstation, OBNAGG, SPDC PEB facilities, SOKU booster station, Nun-River flowstation, Izonbe flowstation, Osa platform. Entered a JV with Bumi Armada to provide EPCI, O&M of FPSO, FSO, E',
      ...
      'EPCI, O & M of Armada Perdana FPSO of the FPSO Armada Perdana for Oyo field development on behalf of CAM.',
